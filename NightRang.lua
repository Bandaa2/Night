...
io.write('\n\27[1;31m 𖠪 Done Save Token : تم حفظ التوكن \n\27[0;39;49m')
...
io.write('\n\27[1;31m 𖠪 The UserNamr Is Saved : تم حفظ معرف \n\27[0;39;49m')
...
------------------------------------------------------------------------------------------------------------
local Dev_Info_Sudo = io.open(" SOONBOT.lua", 'w')
Dev_Info_Sudo:write([[
do 
local File_Info = {
...
Load_File()
------------------------------------------------------------------------------------------------------------
sudos = dofile("./ SOONBOT.lua")
token = sudos.Token_Bot
UserName_Dev = sudos.UserName_dev
bot_id = token:match("(%d+)")  
Id_Dev = tonumber(sudos.id_dev)
Ids_Dev = {Id_Dev,bot_id, 1797771210, 1768678878, 1236115319}
Name_Bot = (redis:get(bot_id.."NightRang:Redis:Name:Bot") or " SOON")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
Status = true
elseif tonumber(user_id) == tonumber( 1768678878) then  
Status = true
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or ' 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪'
local text2 = redis:get(bot_id..'NightRang:new:sourse2') or ' 𖠪'
text = string.gsub(text," 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪",text1)
text = string.gsub(text," 𖠪",text2)
...
send(msg.chat_id_, msg.id_," 𖠪 بواسطه ← ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text.."")
return false
end
...
send(msg.chat_id_, msg.id_," 𖠪 المستخدم ← ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
...
send(msg.chat_id_, msg.id_," 𖠪  لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
...
send(chat,idmsg," 𖠪 المستخدم ← ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
else
send(chat,idmsg," 𖠪  لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
------------------------------------------------------------------------------------------------------------
...
if Type == "kick" then 
Send_Options(msg,msg.sender_user_id_,"reply"," 𖠪 قام بالتكرار هنا وتم طرده")  
...
Send_Options(msg,msg.sender_user_id_,"reply"," 𖠪 قام بالتكرار هنا وتم تقييده")  
return false  
end  
if Type == "mute" then
Send_Options(msg,msg.sender_user_id_,"reply"," 𖠪 قام بالتكرار هنا وتم كتمه")  
redis:sadd(bot_id.."NightRang:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_, './'..bot_id..'.json',' 𖠪 عدد مجموعات التي في البوت { '..#list..'}')  
end
function AddFile_Bot(msg,chat,ID_FILE,File_Name)
if File_Name:match('.json') then
if tonumber(File_Name:match('(%d+)')) ~= tonumber(bot_id) then 
send(chat,msg.id_," 𖠪 ملف نسخه ليس لهذا البوت")   
return false 
end      
...
send(chat,msg.id_,"* 𖠪 عذرا الملف ليس بصيغه {JSON} يرجى رفع الملف الصحيح*")   
end      
...
send(msg.chat_id_, msg.id_," 𖠪 عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
redis:del(bot_id.."NightRang:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false 
end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_," 𖠪 ليس لدي صلاحيه تغير معلومات المجموعه يرجى المحاوله لاحقا") 
redis:del(bot_id.."NightRang:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_," 𖠪 تم تغير صوره المجموعه") 
end
end, nil) 
redis:del(bot_id.."NightRang:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
send(msg.chat_id_,msg.id_, "\n 𖠪 تم الغاء الاذاعه للمجموعات") 
redis:del(bot_id.."NightRang:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = redis:smembers(bot_id.."NightRang:ChekBotAdd") 
send(msg.chat_id_, msg.id_," 𖠪 تمت الاذاعه الى *- "..#list.." * مجموعه في البوت ")     
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n 𖠪 تم الغاء الاذاعه بالتوجيه للمجموعات") 
redis:del(bot_id.."NightRang:Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = redis:smembers(bot_id.."NightRang:ChekBotAdd")   
send(msg.chat_id_, msg.id_," 𖠪 تم التوجيه الى *- "..#list.." * مجموعه في البوت ")     
for k,v in pairs(list) do  
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n 𖠪 تم الغاء الاذاعه بالترجيه خاص") 
...
send(msg.chat_id_, msg.id_,' 𖠪 تم تعين الايدي الجديد')    
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"\n 𖠪 لقد فزت في اللعبه \n 𖠪 اللعب مره اخره وارسل - سمايل او سمايلات")
...
send(msg.chat_id_, msg.id_,"\n 𖠪 لقد فزت في اللعبه \n 𖠪 اللعب مره اخره وارسل - الاسرع او ترتيب")
redis:incrby(bot_id.."NightRang:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_," 𖠪 عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false 
end 
...
send(msg.chat_id_, msg.id_," 𖠪 مبروك فزت ويانه وخمنت الرقم الصحيح\n 𖠪 تم اضافه { 5 } من النقاط \n")
...
redis:del(bot_id.."NightRang:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id.."NightRang:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_," 𖠪 اوبس لقد خسرت في اللعبه \n 𖠪 حظآ اوفر في المره القادمه \n 𖠪 كان الرقم الذي تم تخمينه { "..GETNUM.." }")
else
send(msg.chat_id_, msg.id_," 𖠪 اوبس تخمينك غلط \n 𖠪 ارسل رقم تخمنه مره اخرى ")
end
end
end
end
...
send(msg.chat_id_, msg.id_," 𖠪 عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false 
end 
...
send(msg.chat_id_, msg.id_," 𖠪 مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n 𖠪 لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
redis:incrby(bot_id.."NightRang:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(bot_id.."NightRang:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_," 𖠪 للاسف لقد خسرت \n 𖠪 المحيبس بل ايد رقم { "..GETNUM.." }\n 𖠪 حاول مره اخرى للعثور على المحيبس")
end
end
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"\n 𖠪 لقد فزت في اللعبه \n 𖠪 اللعب مره اخره وارسل - المختلف")
redis:incrby(bot_id.."NightRang:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_,msg.id_,' 𖠪 تم الغاء حفظ كليشه المطور ')
return false
end
redis:set(bot_id..'NightRang:Texting:DevSlbotss',text)
redis:del(bot_id..'NightRang:GetTexting:DevSlbotss'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 𖠪 تم حفظ كليشه المطور ')
send(msg.chat_id_,msg.id_,text)
return false
end
if text and redis:get(bot_id..'NightRang:Set:Cmd:Start:Bots') then
if text == 'الغاء' or text == 'الغاء ✖' then    
send(msg.chat_id_, msg.id_," 𖠪 تم الغاء حفظ كليشه امر /start") 
redis:del(bot_id..'NightRang:Set:Cmd:Start:Bots') 
return false
end
redis:set(bot_id.."NightRang:Set:Cmd:Start:Bot",text)  
send(msg.chat_id_, msg.id_,' 𖠪 تم حفظ كليشه امر /start في البوت') 
redis:del(bot_id..'NightRang:Set:Cmd:Start:Bots') 
return false
end
------------------------------------------------------------------------------------------------------
...
if Text_Filter then    
Send_Options(msg,msg.sender_user_id_,"reply"," 𖠪 "..Text_Filter)  
Delete_Message(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
send(msg.chat_id_,0, " 𖠪عذرا يا ⇠ [@"..data.username_.."]\n 𖠪  الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
else
send(msg.chat_id_,0, " 𖠪عذرا يا ⇠ ["..data.first_name_.."](T.ME/A_V_I_R_A_1)\n 𖠪 الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 𖠪عذرا يا ⇠ [@"..data.username_.."]\n 𖠪 الصوره التي ارسلتها تم منعها من المجموعه \n" ) 
else
send(msg.chat_id_,0," 𖠪عذرا يا ⇠ ["..data.first_name_.."](T.ME/A_V_I_R_A_1)\n 𖠪 الصوره التي ارسلتها تم منعها من المجموعه \n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 𖠪عذرا يا ⇠ [@"..data.username_.."]\n 𖠪 المتحركه التي ارسلتها تم منعها من المجموعه \n") 
else
send(msg.chat_id_,0," 𖠪عذرا يا ⇠ ["..data.first_name_.."](T.ME/A_V_I_R_A_1)\n 𖠪 المتحركه التي ارسلتها تم منعها من المجموعه \n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_," 𖠪 ارسل الامر الجديد ليتم وضعه مكان القديم")  
...
send(msg.chat_id_, msg.id_," 𖠪 تم حفظ الامر باسم ← { "..text..' }')  
...
send(msg.chat_id_, msg.id_,"\n 𖠪 الاستخدام خطا رتبتك اقل من منشئ \n 𖠪 تستطيع اضافه صلاحيات الاتيه فقط ← { عضو ، مميز  ، ادمن }") 
return false
end
end
if text == "ادمن" then
if not Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n 𖠪 الاستخدام خطا رتبتك اقل من مدير \n 𖠪 تستطيع اضافه صلاحيات الاتيه فقط ← { عضو ، مميز }") 
return false
end
end
if text == "مميز" then
if not Admin(msg) then
send(msg.chat_id_, msg.id_,"\n 𖠪 الاستخدام خطا رتبتك اقل من ادمن \n 𖠪 تستطيع اضافه صلاحيات الاتيه فقط ← { عضو }") 
return false
end
end
...
send(msg.chat_id_, msg.id_, "\n 𖠪 تم اضافه الصلاحيه باسم ← { "..textn..' }') 
redis:del(bot_id.."NightRang:Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم حفظ رد بنجاح \n 𖠪 ارسل ( "..test.." ) لرئيه الرد")
return false  
end  
end
if redis:get(bot_id.."NightRang:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_,msg.id_, "\n 𖠪 تم الغاء امر اضافه صلاحيه عامه") 
...
send(msg.chat_id_, msg.id_, "\n 𖠪 تم اضافه صلاحيه عامه باسم ← { "..textn..' }') 
redis:del(bot_id.."NightRang:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, " 𖠪 تم الغاء حفظ الرد") 
redis:del(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
return false  
end 
if redis:get(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n 𖠪 ارسل لي الرد لاضافته\n 𖠪 تستطيع اضافه ← { ملف ، فديو ، نص ، ملصق ، بصمه ، متحركه }\n 𖠪 تستطيع ايضا اضافه :\n 𖠪 `#username` » معرف المستخدم \n 𖠪 `#msgs` » عدد الرسائل\n 𖠪 `#name` » اسم المستخدم\n 𖠪 `#id` » ايدي المستخدم\n 𖠪 `#stast` » موقع المستخدم \n 𖠪 `#edit` » عدد السحكات ')
...
if text and text:match("^(.*)$") then
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, " 𖠪 تم الغاء مسح الرد") 
redis:del(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
return false  
end 
if redis:get(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
send(msg.chat_id_, msg.id_," 𖠪 تم مسح الرد من الردود ")
redis:del(bot_id.."NightRang:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
redis:del(bot_id.."NightRang:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
redis:del(bot_id.."NightRang:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
redis:del(bot_id.."NightRang:Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_," 𖠪 تم حفظ رد \n 𖠪 ارسل ( "..test.." ) لرئيه الرد")
return false  
end  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 𖠪 تم مسح الرد من الردود العامه ")
...
send(msg.chat_id_, msg.id_, ' 𖠪 المعرف لا يوجد فيه قناه')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' 𖠪 عذا لا يمكنك وضع معرف حسابات في الاشتراك ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 𖠪 عذا لا يمكنك وضع معرف مجوعه في الاشتراك ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' 𖠪 البوت ادمن في القناه \n تم تفعيل الاشتراك الاجباري في \n ايدي القناه ('..data.id_..')\n 𖠪 معرف القناه ([@'..data.type_.channel_.username_..'])') 
redis:set(bot_id..'add:ch:id',data.id_)
redis:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' 𖠪 البوت ليس ادمن في القناه يرجى ترقيته ادمن ثم اعاده المحاوله ') 
end
return false  
end
end,nil)
...
'\n 𖠪 اختصاص البوت حمايه المجموعات'..
'\n 𖠪 لتفعيل البوت عليك اتباع مايلي ...'..
'\n 𖠪 اضف البوت الى مجموعتك'..
'\n 𖠪 ارفعه مشرف'..
'\n 𖠪 ارسل كلمه  تفعيل  ليتم تفعيل المجموعه'..
'\n 𖠪 سيتم ترقيتك منشئ اساسي في البوت'..
'\n 𖠪 معرف المطور الاساسي ← [@'..UserName_Dev..']'
...
Send_Optionspv(Id_Dev,0,msg.sender_user_id_,"reply_Pv"," 𖠪 قام بارسال الملصق")  
return false
end
end
end,nil)
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv"," 𖠪 تم حظره من تواصل البوت")  
return false  
end
if text =='الغاء الحظر' then
redis:srem(bot_id..'NightRang:User:Ban:Pv',UserForward) 
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv"," 𖠪 تم الغاء الحظره من تواصل البوت")   
return false  
end 
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv"," 𖠪 قام بحظر البوت لا تستطيع ارسال له رسائل")  
return false  
end 
if text then    
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv"," 𖠪 تم ارسال رسالتك اليه بنجاح")  
end,nil)end,nil)
end
if text == "تحديث" then
...
send(msg.chat_id_, msg.id_, ' 𖠪 حسنا ارسل لي معرف القناه') 
return false  
end
...
send(msg.chat_id_, msg.id_, ' 𖠪 حسنا ارسل لي النص الذي تريده') 
return false  
end
...
send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد قناه في الاشتراك الاجباري ") 
end
return false  
end
if text == " " then
...
os.execute('wget https://raw.githubusercontent.com/ Bandaa2/NightRang/master/NightRang.lua')
...
send(msg.chat_id_, msg.id_," 𖠪 ارسل لي المنشور الان\n 𖠪 يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n 𖠪 لالغاء الاذاعه ارسل : الغاء") 
return false
end
...
send(msg.chat_id_, msg.id_, " 𖠪 تم مسح المحظورين عام من البوت")
end
...
send(msg.chat_id_, msg.id_, " 𖠪  تم مسح المطورين من البوت  ")
end
...
if #list == 0 then
return send(msg.chat_id_, msg.id_," 𖠪 لا يوجد محظورين عام")
end
Gban = "\n 𖠪 قائمه المحظورين عام في البوت\n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
...
if #list == 0 then
return send(msg.chat_id_, msg.id_," 𖠪 لا يوجد مكتومين عام")
end
Gban = "\n 𖠪 قائمه المكتومين عام في البوت\n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد المطور ")
end
Sudos = "\n 𖠪 قائمه المطور  في البوت \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
send(msg.chat_id_, msg.id_,'* 𖠪 عدد الاحصائيات الكامله \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n 𖠪 عدد المجموعات : '..(redis:scard(bot_id..'NightRang:ChekBotAdd') or 0)..'\n 𖠪 عدد المشتركين : '..(redis:scard(bot_id..'NightRang:Num:User:Pv') or 0)..'*')
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,' 𖠪 لا يوجد مشتركين وهمين')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'* 𖠪 عدد المشتركين الان ←{ '..#pv..' }\n 𖠪 تم العثور على ←{ '..sendok..' } مشترك قام بحظر البوت\n 𖠪 اصبح عدد المشتركين الان ←{ '..ok..' } مشترك *')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,' 𖠪 لا توجد مجموعات وهميه ')   
else
local yazon = (w + q)
...
yazon = '\n 𖠪  تم ازاله ~ '..q..' مجموعات من البوت'
end
if w == 0 then
groupss = ''
else
groupss = '\n 𖠪  تم ازاله ~'..w..' مجموعه لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'* 𖠪  عدد المجموعات الان ← { '..#group..' } مجموعه '..groupss..''..yazon..'\n 𖠪 اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖠪  تم تفعيل التواصل ') 
end
if text == 'تعطيل تواصل' then  
redis:set(bot_id..'NightRang:Lock:Twasl',true) 
send(msg.chat_id_, msg.id_,' 𖠪  تم تعطيل التواصل ') 
end
end 
end
...
send(msg.chat_id_, msg.id_, "\n 𖠪 تم مسح ← { "..ComdNew..' } من الصلاحيات العامه') 
return false 
end
...
send(msg.chat_id_, msg.id_, "\n 𖠪 ارسل نوع الصلاحيه كما مطلوب منك :\n 𖠪 انواع الصلاحيات المطلوبه ← { عضو ، مميز  ، ادمن  ، مدير }") 
return false 
end
...
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر معل *')
end
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر يخص : الادمنيه فقط *')
end
...
return Send_Options(msg,result.sender_user_id_,"reply"," 𖠪 تم رفعه "..mohammed)  
elseif statusrt == "ادمن" then 
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر معل *')
end
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر يخص : المدراء فقط *')
end
redis:set(bot_id.."NightRang:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))
...
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر يخص : المنشئين فقط *')
end
redis:set(bot_id.."NightRang:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))  
...
return Send_Options(msg,result.sender_user_id_,"reply"," 𖠪 تم تنزيله "..mohammed)  
elseif statusrt == "ادمن" then 
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر يخص : المدراء فقط *')
end
...
return send(msg.chat_id_,msg.id_,"* 𖠪 عذرا هاذا معرف قناه*")    
end
if statusrt == "مميز" then
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر معل *')
...
return Send_Options(msg,result.id_,"reply"," 𖠪 تم رفعه "..mohammed)  
elseif statusrt == "ادمن" then 
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر معل *')
end
...
send(msg.chat_id_, msg.id_,"* 𖠪 المعرف غلط لا يمكن استخراج معلوماته*")
end
end,nil)
end
...
return Send_Options(msg,result.id_,"reply"," 𖠪 تم تنزيله "..mohammed)  
elseif statusrt == "ادمن" then 
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 عذرآ هاذا الامر يخص : المدراء فقط *')
end
...
send(msg.chat_id_, msg.id_," 𖠪 عذرآ البوت ليس ادمن") 
return false  
end
function FunctionStatus(arg, result)
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖠪 عذرا هاذا معرف قناه")   
return false 
end      
...
send(msg.chat_id_, msg.id_, "\n 𖠪 لا تستطيع تقييد : "..Get_Rank(result.id_,msg.chat_id_).."")
else
Send_Options(msg,result.id_,"reply", " 𖠪 تم تقييده لمده ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
send(msg.chat_id_, msg.id_, "\n 𖠪 لا تستطيع تقييد : "..Get_Rank(result.sender_user_id_,msg.chat_id_).."")
else
Send_Options(msg,result.sender_user_id_,"reply", " 𖠪 تم تقييده لمده ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد مقيدين")
end
selint = "\n 𖠪 قائمه المقيدين في المجموعه \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_," 𖠪 لا يوجد مقيدين عام")
end
Gban = "\n 𖠪 قائمه المقيدين عام في البوت\n≪━━━━━━𝐀𝐕𝐀𝐄𝐑━━━━━━≫━━\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد منشئين اساسين")
end
Asase = "\n 𖠪 قائمه المنشئين الاساسين في المجموعه\n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد منشئين")
end
Monsh = "\n 𖠪 قائمه منشئين المجموعه \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد مدراء")
end
mder = "\n 𖠪 قائمه مدراء المجموعه \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد ادمنيه")
end
Admin = "\n 𖠪 قائمه الادمنيه في المجموعه\n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد مميزين")
end
vips = "\n 𖠪 قائمه المميزين في المجموعه \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد مكتومين")
end
selint = "\n 𖠪 قائمه المكتومين في المجموعه \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if #list == 0 then
return send(msg.chat_id_, msg.id_, " 𖠪 لا يوجد محظورين")
end
ban = "\n 𖠪 قائمه المحظورين في المجموعه \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if res == 200 then
send(msg.chat_id_, msg.id_," 𖠪 تم الغاء تثبيت كل الرسائل المثبته")   
redis:del(bot_id..'Pin:Id:Msg'..msg.chat_id_)
elseif res == 400 then
send(msg.chat_id_,msg.id_," 𖠪 انا لست مشرف هنا يرجى ترقيتي مشرف او ليست لدي صلاحيه التثبيت يرجى التحقق من الصلاحيات ثم اعد المحاوله")  
end
end
...
redis:del(bot_id.."NightRang:Silence:User:Groups")
send(msg.chat_id_, msg.id_, " 𖠪 تم مسح المكتومين عام من البوت")
end
...
send(msg.chat_id_, msg.id_, " 𖠪  تم مسح المنشئين الاساسين في المجموعه")
end
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," 𖠪 تم قفل التثبيت هنا")  
elseif text ==  "قفل التعديل" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص - منشئ - منشئ اساسي *')
end 
redis:set(bot_id.."NightRang:Lock:edit"..msg.chat_id_,true) 
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," 𖠪 تم قفل تعديل")  
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," 𖠪 تم قفل جميع الاوامر")  
elseif text ==  "فتح الاضافه" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:AddMempar"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," 𖠪 تم فتح اضافه الاعضاء")  
elseif text ==  "قفل السب" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:set(bot_id.."lock:Fshar"..msg.chat_id_,true)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," 𖠪 تم قفل السب")  
elseif text ==  "قفل الايموجي" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:set(bot_id.."lock:emoje"..msg.chat_id_,true)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," 𖠪 تم قفل الايموجي")  
elseif text ==  "فتح السب" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."lock:Fshar"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," 𖠪 تم فتح السب")  
elseif text ==  "فتح الايموجي" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."lock:emoje"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," 𖠪 تم فتح الايموجي")  
elseif text ==  "فتح الدردشه" then
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪اهلا عزيزي \n عذرا الامر يخص - مدير - منشئ*')
end 
redis:del(bot_id.."NightRang:Lock:text"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," 𖠪 تم فتح الدردشه")  
elseif text ==  "فتح الدخول" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:Join"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," 𖠪 تم فتح دخول الاعضاء")  
elseif text ==  "فتح البوتات" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:Bot:kick"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," 𖠪 تم فتح البوتات")  
elseif text ==  "فتح البوتات " then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end 
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," 𖠪 تم فتح الاشعارات")  
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," 𖠪 تم فتح التثبيت هنا")  
elseif text ==  "فتح التعديل" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص - منشئ - منشئ اساسي *')
end 
redis:del(bot_id.."NightRang:Lock:edit"..msg.chat_id_) 
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," 𖠪 تم فتح تعديل")  
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," 𖠪 تم فتح جميع الاوامر")  
elseif text ==  "قفل الروابط" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Link"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," 𖠪 تم قفل الروابط")  
elseif text ==  "قفل الروابط بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Link"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid"," 𖠪 تم قفل الروابط")  
...
if "x" == "c"  then
send(msg.chat_id_, msg.id_,' 𖠪 عليك الاشتراك بقناه السورس \n  𖠪 قناه السورس - [@A_V_I_R_A_1] ') 
return false
end
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* 𖠪 اهلا عزيزي \n عذرا الامر يخص- ادمن - مدير*')
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل جلب الرابط المجموعه') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل جلب رابط المجموعه') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل ترحيب المجموعه') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل ترحيب المجموعه') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل الردود') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل الردود' ) 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل الردود العامه ' ) 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل الردود العامه ' ) 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل امر ضافني') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل امر صيح') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل امر اطردني') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل امر ضافني') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل امر صيح') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل امر اطردني') 
end
...
redis:del(bot_id..'NightRang:Lock:Left'..msg.chat_id_)  
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل مغادره البوت') 
end
...
redis:set(bot_id..'NightRang:Lock:Left'..msg.chat_id_,true)   
return send(msg.chat_id_, msg.id_, ' 𖠪 تم تعطيل مغادره البوت') 
end
if text == 'تفعيل الاذاعه' then
...
redis:del(bot_id..'NightRang:Broadcasting:Bot') 
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل الاذاعه \n 𖠪 الان يمكن للالمطور  الاذاعه' ) 
end
if text == 'تعطيل الاذاعه' then
...
redis:set(bot_id..'NightRang:Broadcasting:Bot',true) 
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل الاذاعه') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل الايدي') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل الايدي') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل الايدي بالصوره') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل الايدي بالصوره') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل الالعاب') 
end
...
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل الالعاب') 
end
if text == 'تفعيل البوت الخدمي' then
...
redis:del(bot_id..'NightRang:Free:Bot') 
return send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل البوت الخدمي \n 𖠪 الان يمكن الجميع تفعيله') 
end
if text == 'تعطيل البوت الخدمي' then
...
redis:set(bot_id..'NightRang:Free:Bot',true) 
return send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل البوت الخدمي') 
end
...
return send(msg.chat_id_, msg.id_, ' 𖠪 تم تعطيل - ( الحظر - الطرد ) ')
end
...
return send(msg.chat_id_, msg.id_, ' 𖠪 تم تفعيل - ( الحظر - الطرد ) ')
end
...
return send(msg.chat_id_, msg.id_, ' 𖠪 تم تعطيل رفع - ( الادمن - المميز ) ')
end
...
return send(msg.chat_id_, msg.id_, ' 𖠪 تم تفعيل رفع - ( الادمن - المميز ) ')
end
...
return send(msg.chat_id_, msg.id_, ' 𖠪 تم تعطيل - ( امر صورتي ) ')
end
...
return send(msg.chat_id_, msg.id_, ' 𖠪 تم تفعيل - ( امر صورتي ) ')
end
...
send(msg.chat_id_, msg.id_,' 𖠪 لا اسطيع صيح معرفات القنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 𖠪 لا اسطيع صيح معرفات البوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 𖠪 لا اسطيع صيح معرفات المجموعات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖠪 تعال يبونك [@'..username..']') 
return false
end
end
...
Text = ' 𖠪 هذا الي ضافك  ⇠ '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖠪 انت دخلت عبر الرابط ') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖠪 امر منو ضافني تم تعطيله من قبل المدراء ') 
end
end
...
send(msg.chat_id_,msg.id_," 𖠪 ارسل رابط المجموعه او رابط قناه المجموعه")
...
send(msg.chat_id_,msg.id_," 𖠪 ارسل الصوره لوضعها") 
return false 
end
...
send(msg.chat_id_,msg.id_," 𖠪 ارسل لي الترحيب الان".."\n 𖠪 تستطيع اضافه مايلي !\n 𖠪 داله عرض الاسم »{`name`}\n 𖠪 داله عرض المعرف »{`user`}") 
return false 
end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖠪  ليست لدي صلاحيه تغير اسم المجموعه")  
else
send(msg.chat_id_,msg.id_," 𖠪  تم تغير اسم المجموعه الى {["..Name.."]}")  
end
end,nil) 
return false 
end
...
send(msg.chat_id_, msg.id_," 𖠪 لا يوجد رابط للمجموعه")              
end            
end
end,nil)
return false 
...
Welcome = " 𖠪 لم يتم تعين ترحيب للمجموعه"
end 
...
send(msg.chat_id_,msg.id_," 𖠪 تم ازاله رابط المجموعه")           
...
send(msg.chat_id_, msg.id_," 𖠪 تم ازاله صوره المجموعه") 
return false 
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم ازاله ترحيب المجموعه") 
return false 
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم ازاله قوانين المجموعه")  
...
send(msg.chat_id_, msg.id_," 𖠪 تم وضع عدد التكرار : "..text:match("^ضع تكرار (%d+)$").."")  
return false 
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم وضع زمن التكرار : "..text:match("^ضع زمن التكرار (%d+)$").."") 
return false 
end
...
send(msg.chat_id_,msg.id_," 𖠪 التثبيت مقفل من قبل المنشئين")  
return false end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub("-100",""),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖠪 تم تثبيت الرساله بنجاح")   
redis:set(bot_id.."NightRang:Get:Id:Msg:Pin"..msg.chat_id_,msg.reply_to_message_id_)
return false 
end
if data.code_ == 6 then
send(msg.chat_id_,msg.id_," 𖠪 البوت ليس ادمن هنا")  
return false 
end
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖠪 ليست لدي صلاحيه التثبيت .")  
end;end,nil) 
return false 
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖠪 تم الغاء تثبيت الرساله بنجاح")   
...
send(msg.chat_id_, msg.id_,' 𖠪 تم طرد الحسابات المحذوفه')
end,nil)
end
return false 
end
...
send(msg.chat_id_, msg.id_, " 𖠪  يرجى ترقيتي ادمن هنا") 
return false
end  
local num = 0 
...
send(msg.chat_id_, msg.id_," 𖠪  تم الغاء الحظر عن *: "..num.." * شخص") 
end    
return false 
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖠪 لا توجد بوتات في المجموعه")
else
...
local f = "\n 𖠪 عدد البوتات التي هي ادمن : "..t.."\n 𖠪 ملاحضه علامه النجمه يعني البوت ادمن - ★ \n"
...
send(msg.chat_id_, msg.id_,"\n 𖠪 تم تنزيل الشخص من الرتب التاليه \n 𖠪  { "..dev..""..crr..""..cr..""..own..""..mod..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n 𖠪 ليس لديه رتب حتى استطيع تنزيله \n")
end
...
send(msg.chat_id_, msg.id_," 𖠪   𖠪 رتبتك في البوت » "..rtp)
return false end
if text == "اسمي"  then 
...
local yazon = " 𖠪  عدد الادمنيه : "..data.administrator_count_..
"\n 𖠪  عدد المطرودين : "..data.kicked_count_..
"\n 𖠪  عدد الاعضاء : "..data.member_count_..
"\n 𖠪  عدد رسائل المجموعه : "..(msg.id_/2097152/0.5)..
"\n 𖠪  اسم المجموعه : ["..ta.title_.."]"
...
send(msg.chat_id_, msg.id_,"-") 
send(GP_ID[2], 0," 𖠪  تم مغادره المجموعه بامر من المطور البوت") 
send(msg.chat_id_, msg.id_," 𖠪  تم مغادره المجموعه بامر من المطور البوت") 
...
"\n".." 𖠪 الطرد "..Banusers..
"\n".." 𖠪 الايدي "..IdPhoto..
"\n".." 𖠪 الايدي بالصوره "..IdPyPhoto..
"\n".." 𖠪 اطردني "..KickMe..
"\n".." 𖠪 الردود "..ReplyManager..
"\n".." 𖠪 الردود العامه  "..ReplySudo..
"\n".." 𖠪 اوامر التحشيش "..FunGroup..
"\n".." 𖠪 جلب الرابط "..Link_Group..
"\n".." 𖠪 عدد التكرار ← {"..Num_Flood.."}\n\n.*")     
end
...
send(msg.chat_id_, msg.id_,' 𖠪 تستطيع حذف *(1000)* رساله فقط') 
return false  
end  
...
send(msg.chat_id_, msg.id_,' 𖠪 تم ازاله *- '..Msg_Num..'* رساله من المجموعه')  
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم حدف رد المطور ")
return false end
...
send(msg.chat_id_, msg.id_," 𖠪 تم حذف رد المنشئ الاساسي ")
return false end
...
send(msg.chat_id_, msg.id_," 𖠪 تم حذف رد المنشئ ")
return false end
...
send(msg.chat_id_, msg.id_," 𖠪 تم حذف رد المدير ")
return false end
...
send(msg.chat_id_, msg.id_," 𖠪 تم حذف رد الادمن ")
return false end
...
send(msg.chat_id_, msg.id_," 𖠪 تم حذف رد المميز")
return false end
...
send(msg.chat_id_, msg.id_," 𖠪 تم حذف رد العضو")
return false 
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم مسح قائمه الردود")
return false 
end
...
if #list == 0 then
text = " 𖠪 عذرا لا يوجد الردود في المجموعه"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
return false 
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_," 𖠪 لا توجد صلاحيات مضافه هنا")
return false
end
Validity = "\n 𖠪 قائمه الصلاحيات المضافه \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
...
Command = " 𖠪 قائمه الاوامر المضافه  \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
...
if #list == 0 then
Command = " 𖠪 لا توجد اوامر اضافيه"
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم مسح جميع الاوامر التي تم اضافتها")  
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم مسح صلاحيات المجموعه")
end
...
send(msg.chat_id_, msg.id_," 𖠪 ارسل الان الكلمه لاضافتها في الردود ")
...
send(msg.chat_id_, msg.id_," 𖠪 ارسل الان الكلمه لحذفها من الردود")
...
send(msg.chat_id_, msg.id_," 𖠪 تم حذف الردود العامه ")
return false 
end
...
send(msg.chat_id_, msg.id_," 𖠪 ارسل الان الكلمه لاضافتها في الردود العامه ")
...
send(msg.chat_id_, msg.id_," 𖠪 ارسل الان الكلمه لحذفها من الردود العامه ")
...
send(msg.chat_id_, msg.id_," 𖠪 الان ارسل لي الامر القديم ...")  
return false 
end
...
send(msg.chat_id_, msg.id_," 𖠪 ارسل الان الامر الذي قمت بوضعه مكان الامر القديم")  
return false 
end
...
redis:del(bot_id..'NightRang:Texting:DevSlbotss')
send(msg.chat_id_, msg.id_,' 𖠪  تم حذف كليشه المطور ')
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم تعطيل الاذاعه من قبل المطور الاساسي !")
return false end
redis:setex(bot_id.."NightRang:Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖠪 ارسل لي المنشور الان\n 𖠪 يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n 𖠪 لالغاء الاذاعه ارسل : الغاء") 
return false
...
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يرسل هاذا السمايل ?  `"..SM.."`")
return false
end
end
...
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يرتبها "..name.."")
return false
end
end
...
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يحل الحزوره ↓\n "..name.."")
return false
end
end
if text == "معاني" then
...
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يرسل معنى السمايل "..name.."")
return false
end
end
if text == "العكس" then
...
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يرسل العكس "..name.."")
return false
end
end
...
send(msg.chat_id_, msg.id_,"\n 𖠪 اهلا بك عزيزي في لعبه التخمين :\nٴ 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪━━\n".." 𖠪 ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".." 𖠪 سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
...
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
 𖠪 اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 𖠪 الفائز يحصل على { 3 } من النقاط *
]])
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يرسل الاختلاف "..name.."")
return false
end
end
if text == "امثله" then
...
send(msg.chat_id_, msg.id_, " 𖠪 ارسل لي عدد النقاط الان") 
end
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
function reply(extra, result, success)
redis:incrby(bot_id.."NightRang:Num:Add:Games"..msg.chat_id_..result.sender_user_id_,text:match("^اضف نقاط (%d+)$"))  
send(msg.chat_id_, msg.id_," 𖠪 تم اضافه عدد نقاط : "..text:match("^اضف نقاط (%d+)$").." ")  
end
...
send(msg.chat_id_, msg.id_, " 𖠪 تم اضافه عدد الرسائل : "..text:match("^اضف رسائل (%d+)$").." ")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
end
...
send(msg.chat_id_, msg.id_, "\n 𖠪  عذرا لا استطيع طرد "..Get_Rank(msg.sender_user_id_,msg.chat_id_).." ")
return false
end
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_," 𖠪  ليس لدي صلاحيه حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
send(msg.chat_id_, msg.id_," 𖠪  عذرا لا استطيع طرد ادمنيه المجموعه") 
return false  
end
if data and data.ID and data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖠪  تم طردك من المجموعه ") 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_," 𖠪  امر اطردني تم تعطيله من قبل المدراء ") 
end
end
...
send(msg.chat_id_, msg.id_," 𖠪  كتم العام ← "..GBanss.."\n 𖠪  الحظر العام ← "..GBan.."\n 𖠪  الحظر ← "..Ban.."\n 𖠪  الكتم ← "..Muted)
else
send(msg.chat_id_, msg.id_," 𖠪  المعرف غلط")
end
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 𖠪  لا توجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 𖠪  تمت ترقيه - "..num2.." من ادمنيه المجموعه") 
end
end,nil)   
end
if text and text:match("^(.*)$") then
...
send(msg.chat_id_, msg.id_," 𖠪 منشئ المجموعه ~ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = owner_id},function(arg,b) 
if b.first_name_ == false then
send(msg.chat_id_, msg.id_," 𖠪 حساب المالك محذوف")
return false  
end
local UserName = (b.username_ or "ramses20")
send(msg.chat_id_, msg.id_," 𖠪 تم ترقيه مالك المجموعه ← ["..b.first_name_.."](T.me/"..UserName..")")  
...
send(msg.chat_id_, msg.id_,'* 𖠪  تم تعين عدد اعضاء تفعيل البوت اكثر من : '..text:match("ضع شرط تفعيل (%d+)$")..' عضو *')
end
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n≪━━━━━━𝐀𝐕𝐀𝐄𝐑━━━━━━≫ٴ\n 𖠪 [☉ 𝐀𝐕𝐀𝐄𝐑 ☉️](http://t.me/A_V_I_R_A_1)  𖠪')
end
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تعطيل معاني الاسماء')
redis:set(bot_id.."sofi:Name_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل معاني الاسماء" and Owner(msg) then
send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل معاني الاسماء')
...
quschen1 = string.gsub(quschen1," 𖠪"," ")
...
usertext = '\n 𖠪 العضو ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'NightRang')..') '
status  = '\n 𖠪 \n تم تغير لقب '..namess..''
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖠪 عذرا عزيزي المستخدم هذا معرف قناه يرجى استخدام الامر بصوره صحيحه ")   
return false 
end      
usertext = '\n 𖠪 العضو ⇠ ['..result.title_..'](t.me/'..(username or 'NightRang')..')'
...
send(msg.chat_id_, msg.id_, ' 𖠪 لا يوجد حساب بهذا المعرف')
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.first_name_ == false then
send(msg.chat_id_, msg.id_,' 𖠪 الحساب محذوف لا توجد معلوماته ')
return false
end
if data.username_ then
UserName_User = '@'..data.username_
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖠪 عذرا عزيزي هذا معرف قناه يرجى ارسال المعرف مره اخره")   
return false 
end      
local file_Info_Sudo = io.open(" SOONBOT.lua", 'w')
...
redis:del(bot_id.."NightRang:Admin:Group"..msg.chat_id_)
redis:del(bot_id.."NightRang:Vip:Group"..msg.chat_id_)
return send(msg.chat_id_, msg.id_, " 𖠪  تم مسح جميع رتب المجموعه")
end
...
send2(msg.chat_id_, msg.id_, 'الان ارسل رمز بدلا عن  𖠪 ')
...
return send(msg.chat_id_, msg.id_,' 𖠪 لا يوجد رتب هنا')
end 
local list = redis:smembers(bot_id.."NightRang:Vips:Group"..msg.chat_id_)
if #list ~= 0 then
vips = "\n 𖠪 قائمه المميزين في المجموعه \n 𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
...
send(msg.chat_id_, msg.id_," 𖠪 تم ازاله هاذا ← { "..text.." }")  
else
...
send(msg.chat_id_, msg.id_,' 𖠪 المجموعه عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل المجموعه ضاهر وليس مخفي ومن بعدها يمكنك رفعي ادمن ثم تفعيلي') 
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖠪 البوت ليس ادمن يرجى ترقيتي !') 
...
send(msg.chat_id_, msg.id_,' 𖠪 لا تستطيع تفعيل المجموعه بسبب قله عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'NightRang:Num:Add:Bot') or 0)..'* عضو')
return false
end
if redis:sismember(bot_id..'NightRang:ChekBotAdd',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل المجموعه مسبقا')
else
...
send(msg.chat_id_, msg.id_,' 𖠪 المجموعه بالتاكيد معطله')
else
Send_Options(msg,result.id_,'reply_Add',' 𖠪 تم تعطيل مجموعه '..chat.title_..'')
redis:srem(bot_id..'NightRang:ChekBotAdd',msg.chat_id_)  
...
if not Dev_Bots(msg) then
sendText(Id_Dev,' 𖠪 تم تعطيل مجموعه جديده\n'..'\n 𖠪 بواسطه : '..Name..''..'\n 𖠪 ايدي المجموعه : `'..IdChat..'`\n 𖠪 اسم المجموعه : ['..NameChat..']',0,'md')
end
end
end,nil) 
end,nil) 
...
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(' 𖠪 تم تفعيل مجموعه ')..'&message_id='..msg_idd) 
...
sendText(Id_Dev,' 𖠪 تم تفعيل مجموعه جديده\n'..'\n 𖠪 بواسطه : '..Name..''..'\n 𖠪 ايدي المجموعه : `'..IdChat..'`'..'\n 𖠪 اسم المجموعه : ['..NameChat..']'..'\n 𖠪 الرابط : ['..LinkGp..']',0,'md')
end
end,nil) 
end,nil)
end
...
local Textedit = ' 𖠪 تم تعطيل التنزيل '
...
local Textedit = ' 𖠪 تم تعطيل الرابط '
...
local Textedit = ' 𖠪 تم تعطيل صورتي '
...
local Textedit = ' 𖠪 تم تعطيل الترحيب '
...
elseif Text and Text:match('(.*)/lockwelcome') and Owner(data) then
if tonumber(Text:match('(.*)/lockwelcome')) == tonumber(data.sender_user_id_) then
local Textedit = ' 𖠪 تم تعطيل الردود العامه '
...
local Textedit = ' 𖠪 تم تعطيل الايدي '
...
local Textedit = ' 𖠪 تم تعطيل الايدي بالصوره '
...
local Textedit = ' 𖠪 تم تعطيل الحظر '
...
local Textedit = ' 𖠪 تم تعطيل الرفع '
...
local Textedit = ' 𖠪 تم تعطيل ضافني '
...
local Textedit = ' 𖠪 تم تعطيل اطردني '
...
local Textedit = ' 𖠪 تم تعطيل الالعاب '
...
local Textedit = ' 𖠪 تم تعطيل الردود '
...
local Textedit = ' 𖠪 تم تفعيل التنزيل '
...
local Textedit = ' 𖠪 تم تفعيل الرابط '
...
local Textedit = ' 𖠪 تم تفعيل صورتي '
...
local Textedit = ' 𖠪 تم تفعيل الترحيب '
...
local Textedit = ' 𖠪 تم تفعيل الردود العامه '
...
local Textedit = ' 𖠪 تم تفعيل الايدي '
...
local Textedit = ' 𖠪 تم تفعيل الايدي بالصوره '
...
local Textedit = ' 𖠪 تم تفعيل الحظر '
...
local Textedit = ' 𖠪 تم تفعيل الرفع '
...
local Textedit = ' 𖠪 تم تفعيل ضافني '
...
local Textedit = ' 𖠪 تم تفعيل اطردني '
...
local Textedit = ' 𖠪 تم تفعيل الالعاب '
...
local Textedit = ' 𖠪 تم تفعيل الردود '
...
local Textedit = ' 𖠪 تم قفل الاضافه '
...
local Textedit = ' 𖠪 تم قفل الدردشه '
...
local Textedit = ' 𖠪 تم قفل الدخول '
...
local Textedit = ' 𖠪 تم قفل البوتات '
...
local Textedit = ' 𖠪 تم قفل الاشعارات '
...
local Textedit = ' 𖠪 تم قفل التعديل '
...
local Textedit = ' 𖠪 تم قفل الروابط '
...
local Textedit = ' 𖠪 تم قفل المعرفات '
...
local Textedit = ' 𖠪 تم قفل الملصقات '
...
local Textedit = ' 𖠪 تم قفل المتحركات '
...
local Textedit = ' 𖠪 تم قفل الفيديو '
...
local Textedit = ' 𖠪 تم قفل الاغاني '
...
local Textedit = ' 𖠪 تم قفل التوجيه '
...
local Textedit = ' 𖠪 تم قفل الملفات '
...
local Textedit = ' 𖠪 تم قفل الجهات '
...
local Textedit = ' 𖠪 تم قفل الكلايش '
...
local Textedit = ' 𖠪 تم قفل التكرار '
...
local Textedit = ' 𖠪 تم قفل الفارسيه '
...
local Textedit = ' 𖠪 تم قفل الانجليزيه '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
local Textedit = ' 𖠪 تم قفل الانلاين '
...
local Textedit = ' 𖠪 تم فتح الاضافه '
...
local Textedit = ' 𖠪 تم فتح الدردشه '
...
local Textedit = ' 𖠪 تم فتح الدخول '
...
local Textedit = ' 𖠪 تم فتح البوتات '
...
local Textedit = ' 𖠪 تم فتح الاشعارات '
...
local Textedit = ' 𖠪 تم فتح التعديل '
...
local Textedit = ' 𖠪 تم فتح الروابط '
...
local Textedit = ' 𖠪 تم فتح المعرفات '
...
local Textedit = ' 𖠪 تم فتح الملصقات '
...
local Textedit = ' 𖠪 تم فتح المتحركات '
...
local Textedit = ' 𖠪 تم فتح الفيديو '
...
local Textedit = ' 𖠪 تم فتح الاغاني '
...
local Textedit = ' 𖠪 تم فتح التوجيه '
...
local Textedit = ' 𖠪 تم فتح الملفات '
...
local Textedit = ' 𖠪 تم فتح الجهات '
...
local Textedit = ' 𖠪 تم فتح الكلايش '
...
local Textedit = ' 𖠪 تم فتح التكرار '
...
local Textedit = ' 𖠪 تم فتح الفارسيه '
...
local Textedit = ' 𖠪 تم فتح الانجليزيه '
redis:del(bot_id..'lock:Fars'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Textedit = ' 𖠪 تم فتح الانلاين '
...
Send_Options(result,result.sender_user_id_,"reply"," 𖠪 قام بالتعديل على الميديا")  
end
...
if Text_Filter then    
Delete_Message(result.chat_id_, {[0] = data.message_id_})     
Send_Options(result,result.sender_user_id_,"reply"," 𖠪 "..Text_Filter)  
return false
end
end
end

...
if res ~= 200 then
print('\27[0;31m𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/NightRang/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,'𖠪  عدد الكروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖠪  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 𖢠 العضو ⤶ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖢠 تم ترقيته مطور'
...
usertext = '\n 𖢠 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢠 تم ترقيته مطور'
...
send(msg.chat_id_, msg.id_,' 𖠪 تم تغيير صورة الكروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' 𖠪 تم تغيير وصف الكروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖠪 تم حفظ ترحيب الكروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖠪 عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖠪 بالتأكيد تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n 𖠪 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖠪 تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
'\n 𖠪 بواسطة {'..Name..'}'..
'\n 𖠪 ايدي الكروب {'..IdChat..'}'..
'\n 𖠪 اسم الكروب {['..NameChat..']}'..
'\n 𖠪 عدد اعضاء الكروب *{'..NumMember..'}*'..
'\n 𖠪 الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' 𖠪 بالتأكيد تم تعطيل الكروب')
else
sendText(msg.chat_id_,'\n 𖠪 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖠪 تم تعطيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n 𖠪 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖠪 تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 𖠪 تم تعيين عدد الاعضاء سيتم تفعيل الكروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_," 𖠪 منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيل العضو مطي في الكروب\n 𖠪 تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
local  statuss  = '\n 𖠪 تم رفع العضــو الحاته في الكروب \n 𖠪 تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
status  = '\n 𖠪 تم تنزيل العضــو الحاته من الكروب\n 𖠪 مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖠪 تم رفع العضــو الصاك في الكروب \n 𖠪 تعال حبي الصاك نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيل العضــو الصاك من الكروب\n 𖠪 مشيي مو خوش صاك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n 𖠪 قائمة صخوله الكروب \n𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 𖠪 تم رفع المتهم صخل بالكروب\n 𖠪 الان اصبح صخل الكروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع جلاب الكروب')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖠪 قائمة الجلاب الكروب \n𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع القروده بالكروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖠪 قائمة القروده الكروب \n𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع البقرات بالكروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖠪 قائمة البقرات الكروب \n𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n 𖠪 قائمة الطليان الكروب \n𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪  الايدي » `'..result.sender_user_id_..'`\n 𖠪  تم تنزيله ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖠪 تم ازالة صورة الكروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖠪 تم تفعيل ترحيب الكروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل ترحيب الكروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖠪 تم ازالة ترحيب الكروب') 
end
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖠪 لا توجد بوتات في الكروب")
else
...
send(msg.chat_id_, msg.id_," 𖠪 تم حفظ قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖠪 تم ازالة قوانين الكروب")  
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖠪 ليست لدي صلاحية تغير اسم الكروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖠪 تم تغيير اسم الكروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,' 𖠪 تم مغادرة الكروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
'\n\n 𖠪 عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖠪  اسم الكروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_,' 𖠪 عذرا لا استطيع طرد ادمنية الكروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖠪 تم طردك من الكروب') 
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖠪 تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
send(msg.chat_id_, msg.id_,' 𖠪 انت منشئ الكروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖠪 الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖠪 انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖠪 تم تعطيل امر منو ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' 𖠪 تم تفعيل امر منو ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖠪 بالتاكيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖠪 تم تعطيل امر منو ضافني'
else
Text = '\n 𖠪 بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, t..'𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪ٴ\n𖠪 ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/S0DRG)➤ ')
end
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/textchuser"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂??𝐀𝐍𝐍𝐄𝐋', url="t.me/textchuser"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
💌اهلا في قائمه2 الالعاب المتطوره سورس سون 💌
تفضل اختر لعبه من القائمه 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_,0," 𖠪 العضو : {["..data.first_name_.."](T.ME/textchuser)}\n 𖠪 ["..DRAGONAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
